...
parser.add_argument('--handin_dir',
                    type=str,
                    default='./submissions/hw2_public_handin/')
...
if __name__ == "__main__":
    ...
    team_dict = util.score_teams("classification", team_list, args.handin_dir,
                                 args.path_prefix, args.batch_size, train_pair,
                                 test_pair)
